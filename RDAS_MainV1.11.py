...
def add_data_point(DropCounter,EntryDataPointValue,listboxSpec,):
...
# Label for "Drop X" prompt in left section
drop_label_left = tk.Label(left_frame, text="Enter value for Drop X (Left):", font=("Arial", 12))
drop_label_left.pack()

# Entry field for data point value in left section
entry_data_point_value_left = tk.Entry(left_frame, font=("Arial", 12))
entry_data_point_value_left.pack(pady=5)

# Button to add data point in left section
add_button_left = tk.Button(left_frame, text="Add Data Point", font=("Arial", 12), command=lambda: add_data_point(drop_counter_left,entry_data_point_value_left))
add_button_left.pack(pady=10)
...
listbox_data_points_left.pack(pady=10)

# ===================== Right Section =====================
label_right = tk.Label(right_frame, text="Add Data Points Menu (Right)", font=("Arial", 16))
label_right.pack(pady=10)

# Label for "Drop X" prompt in right section
drop_label_right = tk.Label(right_frame, text="Enter value for Drop X (Right):", font=("Arial", 12))
drop_label_right.pack()

# Entry field for data point value in right section
entry_data_point_value_right = tk.Entry(right_frame, font=("Arial", 12))
entry_data_point_value_right.pack(pady=5)

# Button to add data point in right section
add_button_right = tk.Button(right_frame, text="Add Data Point", font=("Arial", 12), command=lambda: add_data_point(drop_counter_right,entry_data_point_value_right))
add_button_right.pack(pady=10)

# Listbox to display data points in right section
listbox_data_points_right = tk.Listbox(right_frame, font=("Arial", 12), height=8, width=30)
listbox_data_points_right.pack(pady=10)
